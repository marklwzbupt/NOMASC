...
def load_all_models(time, num_epoch):
    n_encoder_save = "/home/bupt-2/sms_codes/sms_codes/NOMASC/models/City_City/checkpoint_" +str(time) + "/n_encoder_" + str(c) + "_"+str(num_epoch)+"_.pkl"
    f_encoder_save = "/home/bupt-2/sms_codes/sms_codes/NOMASC/models/City_City/checkpoint_" +str(time) + "/f_encoder_" + str(c) + "_"+str(num_epoch)+"_.pkl"
    n_decoder_save = "/home/bupt-2/sms_codes/sms_codes/NOMASC/models/City_City/checkpoint_" +str(time) + "/n_decoder_" + str(c) + "_"+str(num_epoch)+"_.pkl"
    f_decoder_save = "/home/bupt-2/sms_codes/sms_codes/NOMASC/models/City_City/checkpoint_" +str(time) + "/f_decoder_" + str(c) + "_"+str(num_epoch)+"_.pkl"
...
data_path = Path("/usr/Datasets/leftImg8bit_trainvaltest_1/leftImg8bit/all_test_pics")
...
# mse损失函数
mse_fn = nn.MSELoss()
load_all_models("20250117-094728",299)
#加载pre-trained 调制解调器
...
with torch.no_grad():
    for snr in snr_list:
        ...
        for input in loop:
            ...
            image1 = images_ini[0: len(images_ini) //2, :]
            image2 = images_ini[len(images_ini) //2 : len(images_ini), :]
        ...
        plt.subplots_adjust(left=None, bottom=None, right=None, top=None,
                            wspace=0, hspace=0.5)
        plt.savefig("/home/bupt-2/sms_codes/sms_codes/NOMASC/save_images/city_city"+"/"+"recon_snr"+str(snr)+".jpg")
