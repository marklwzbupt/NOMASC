...
result_dir = "/home/bupt-2/sms_codes/sms_codes/NOMASC/models/City_City/checkpoint_" + current_time
...
new_size = 512
train_number = 100000
# data_path = Path("/usr/openimage10w/part1")
...
opendatset = Openimage(data_path, 256)
# opendatset = Cityscapes_data(data_path, 256)
...
dataloader = torch.utils.data.Subset(opendatset, list(range(len(opendatset)-1)))
