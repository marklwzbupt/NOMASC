...
result_dir = "../models/minst_cifar/checkpoint_" + current_time
os.mkdir(result_dir)
...
def save_all_models():
    ...
    n_encoder_save = train_log_filepath + "/n_encoder_" + str(c1) + "_.pkl"
    f_encoder_save = train_log_filepath + "/f_encoder_" + str(c2) + "_.pkl"
    n_decoder_save = train_log_filepath + "/n_decoder_" + str(c1) + "_.pkl"
    f_decoder_save = train_log_filepath + "/f_decoder_" + str(c2) + "_.pkl"
    n_Multi_dis_save = train_log_filepath + "/n_md.pkl"
    f_Multi_dis_save = train_log_filepath + "/f_md.pkl"
